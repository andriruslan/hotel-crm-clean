...
const warnButtonClass =
  'inline-flex min-h-12 w-full items-center justify-center rounded-2xl bg-[var(--crm-warning)] px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#946222] disabled:opacity-60'
const dangerButtonClass =
  'inline-flex min-h-12 w-full items-center justify-center rounded-2xl bg-[var(--crm-danger)] px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#973b3b] disabled:opacity-60'
