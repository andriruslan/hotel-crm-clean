      ...
      {items.map((item) => {
        ...
        if (isMultiSelectEnabled) {
          return (
            <button
              ...
              className={`w-full rounded-3xl border-2 bg-white/90 px-3.5 py-3.5 text-left shadow-[0_10px_24px_rgba(143,45,86,0.08)] transition hover:-translate-y-0.5 hover:bg-[var(--crm-panel)] hover:shadow-lg sm:px-4 sm:py-4 ${
                isSelected
        ...
        return (
          <Link
            ...
            className="rounded-3xl border-2 border-[var(--crm-wine-border)] bg-white/90 px-3.5 py-3.5 shadow-[0_10px_24px_rgba(143,45,86,0.08)] transition hover:-translate-y-0.5 hover:border-[var(--crm-wine)] hover:bg-[var(--crm-panel)] hover:shadow-lg sm:px-4 sm:py-4"
          >
            <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
              <div className="min-w-0">
                <div className="truncate text-base font-bold leading-tight sm:text-lg">Номер {item.room_number}</div>
